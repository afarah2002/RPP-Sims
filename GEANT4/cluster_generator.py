'''
This class can create two different patterns of clusters 
in a 3D coordinate space:

1) sphericalClusters - clusters are produced radially from 
the center of the environment

2) cartesianClusters - clusters are mapped evenly to
the faces of a prism surrounding the environment
'''
